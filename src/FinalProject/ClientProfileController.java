...
public class ClientProfileController implements Initializable {
    ...
    private void dashboardHandle(ActionEvent event) {
        ApplyMethods.moveTo(menuBar, "ClientDashboard.fxml", "Client Dashboard", ClientProfileController.class);
    }

    @FXML
    private void viewProfileHandle(ActionEvent event) {
        ApplyMethods.moveTo(menuBar, "ClientViewProfile.fxml", "View Profile Screen", ClientProfileController.class);
    }

    @FXML
    private void editProfileHandle(ActionEvent event) {
        ApplyMethods.moveTo(menuBar, "ClientEditProfile.fxml", "Edit Profile Screen", ClientProfileController.class);
    }
    ...
    private void logoutHandle(ActionEvent event) {
        ApplyMethods.moveTo(menuBar, "LoginScreen.fxml", "Login Screen", ClientProfileController.class);
    }
