...
public class AdminDashboardController implements Initializable {
    ...
    private void logoutHandle(ActionEvent event) {
        ...
        confirmationDialog.showAndWait().ifPresent(buttonType -> { // to handle the user's choice of buttons
            if (buttonType == confirmButton) {
                ApplyMethods.moveTo(menuBar, "LoginScreen.fxml", "Login Screen", AdminDashboardController.class);
            }
        });
    ...
    @FXML
    private void manageProductsHandle(ActionEvent event) {
        ApplyMethods.moveTo(menuBar, "AdminManageProducts.fxml", "Admin Manage Products Dashboard", AdminDashboardController.class);
    }

    @FXML
    private void manageClientsHandle(ActionEvent event) {
        ApplyMethods.moveTo(menuBar, "AdminManageClients.fxml", "Admin Manage Clients", AdminDashboardController.class);
    }

    @FXML
    private void manageOrdersHandle(ActionEvent event) {
        ApplyMethods.moveTo(menuBar, "AdminOrdersDashboard.fxml", "Admin Manage Orders Dashboard", AdminDashboardController.class);
    }

    @FXML
    private void manageInvoicesHandle(ActionEvent event) {
        ApplyMethods.moveTo(menuBar, "AdminManageInvoices.fxml", "Admin Manage Orders Dashboard", AdminDashboardController.class);
    }

    @FXML
    private void changePasswordHandle(ActionEvent event) {
        ApplyMethods.moveTo(menuBar, "AdminChangePassword.fxml", "Login Screen", AdminDashboardController.class);
    }
